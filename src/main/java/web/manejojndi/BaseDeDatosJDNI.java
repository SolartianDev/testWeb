...
@WebServlet(name = "BaseDeDatosJDNI", urlPatterns = {"/BaseDeDatosJDNI"})

public class BaseDeDatosJDNI extends HttpServlet {
        ...
        try
                 {
                     ...
                     DataSource ds = (DataSource) ctx.lookup("mysql/empresa");
